            ...
            <div class="container">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <a href="{{ route('admin.domain.index') }}" class="btn btn-primary d-none d-sm-inline-block btn-black"><svg
                    ...
                    <form action="{{ route('admin.domain.store') }}" method="POST" role="form">
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="submit" id="submit-domain-create" class="btn btn-primary ms-auto btn-black">
                                    <span class="d-flex justify-content-center align-items-center">
